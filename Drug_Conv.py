...
def StAS(index_A, value_A, index_S, value_S, device, N, kN):  # 子图的连通性
    ...
    index_St, value_St = transpose(index_S, value_S, N, kN)  # 交换维度
...
class ASAP_Pooling(torch.nn.Module):
    ...
    def forward(self, x, edge_index, batch, edge_weight=None):
        ...
        #X_2_2, egde_2_2, batch_2_2, perm_2_2, fitness_2_2, index_S_2_2, value_S_2_2, edge_weight_2_2
